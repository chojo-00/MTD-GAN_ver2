#!/bin/bash
#SBATCH -J mtd_gan_analyze_results_ver2
#SBATCH -t 7-00:00:00
...
# Define vars
JOB_NAME="mtd_gan_analyze_results_ver2"
...
CHECKPOINT_DIR="${CODE_DIR}/checkpoints/Quarter_60to30"
# 테스트 결과 폴더 (pred_results.csv 가 있는 경로)
SAVE_DIR="${CODE_DIR}/test_results/Quarter_60to30" 
# 분석 결과가 섞이지 않도록 하위 폴더 'analysis' 지정
ANALYSIS_DIR="${SAVE_DIR}/ssim_analysis"
